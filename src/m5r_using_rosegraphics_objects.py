...
#                  fill color, outline color, attach to
#
#          -- Write the names of three INSTANCE VARIABLEs
#             that Circle objects have:
#                center point, radius, self
#
#     f. What does a RoseWindow RENDER method do?
#            draws the graphics and  makes them  appear in the window
#
#     g. When is a RoseWindow close_on_mouse_click method call necessary?  Why?
#            When you want the window to stay open after the code runs, if not the window will close after the code runs
#
